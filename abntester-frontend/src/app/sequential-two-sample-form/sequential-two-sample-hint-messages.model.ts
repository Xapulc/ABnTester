...
export const twoSampleHints: HintContentModel[] = [
  {
    ...
    params: {
      alpha: 'Ошибкой I рода называется ситуация, в которой ' +
        ...
        '<li class="tui-list__item"> а на самом деле справедлива гипотеза $H_0: p_1 \\leq p_2$ (конверсия $p_1$ не ниже конверсии $p_2$).</li>' +
        '</ul>' +
  ...
  },
  {
    ...
    params: {
      alpha: 'Ошибкой I рода называется ситуация, в которой ' +
        ...
        '<li class="tui-list__item"> а на самом деле справедлива гипотеза $H_0: p_1 \\geq p_2$ (конверсия $p_1$ не выше конверсии $p_2$).</li>' +
        '</ul>' +
        'Уровень значимости $\\alpha$ является ограничением на вероятность ошибки I рода. ' +
